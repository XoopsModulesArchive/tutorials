...
// -----------------------------------------------------------------------------------------------------------//
$tid = $_GET['tid'];
$result = $xoopsDB->query('select tname, timg, tcont, codes, timgwidth, timgheight from ' . $xoopsDB->prefix('tutorials') . " where tid=$tid");
[$tname, $timg, $tcont, $codes, $timgwidth, $timgheight] = $xoopsDB->fetchRow($result);
